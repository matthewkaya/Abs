...
> Generated: 2026-05-07T10:43:47+00:00 · duration: 0.12s · `7/7` rounds green
...
|---|---|---|---|---|---|
| `—` | anthropic → groq → cerebras → gemini → cloudflare → cohere | `anthropic` | `anthropic` | 0.42 | ✅ |
| `anthropic` | anthropic → groq → cerebras → gemini → cloudflare → cohere | `groq` | `groq` | 0.3 | ✅ |
| `groq` | anthropic → groq → cerebras → gemini → cloudflare → cohere | `anthropic` | `anthropic` | 0.13 | ✅ |
| `cerebras` | anthropic → groq → cerebras → gemini → cloudflare → cohere | `anthropic` | `anthropic` | 0.12 | ✅ |
| `gemini` | anthropic → groq → cerebras → gemini → cloudflare → cohere | `anthropic` | `anthropic` | 0.12 | ✅ |
| `cloudflare` | anthropic → groq → cerebras → gemini → cloudflare → cohere | `anthropic` | `anthropic` | 0.12 | ✅ |
